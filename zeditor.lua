...
function ZCreateTexture( playerid, params )
	...
	if HasEditRights( playerid ) then
		if result == 1 then
			...
			SendPlayerMessage( playerid, 230, 230, 230, "Textures: (1) Frame_GMPA  (20)  Nw_Misc_WindMill_Rotor_01")
            SendPlayerMessage( playerid, 230, 230, 230, "(2) Dlg_Conversation      (11) Focus_Highlight"                )
            SendPlayerMessage( playerid, 230, 230, 230, "(3) Menu_Choice_Back      (12) Inv_Slot_Focus"                 )
            SendPlayerMessage( playerid, 230, 230, 230, "(4) Progress              (13) Menu_Maske"                     )
            SendPlayerMessage( playerid, 230, 230, 230, "(5) Menu_Choice_Back      (14) Menu_Gothic"                    )
            SendPlayerMessage( playerid, 230, 230, 230, "(6) Console               (15) Menu_InGame"                    )
            SendPlayerMessage( playerid, 230, 230, 230, "(7) Saving                (16) Nw_City_Rich_Ceiling_02"        )
            SendPlayerMessage( playerid, 230, 230, 230, "(8) Inv_Slot_Focus        (17) Nw_Ship_Sail_01"                )
            SendPlayerMessage( playerid, 230, 230, 230, "(9) Book_Brown_L          (18) OreHighLight"                   )
            SendPlayerMessage( playerid, 230, 230, 230, "(10) Letters              (19) L"                              )			
		end
	end
end
